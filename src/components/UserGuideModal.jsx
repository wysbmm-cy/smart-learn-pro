...
const UserGuideModal = ({ onClose }) => {
        ...
        switch (activeTab) {
                ...
                return (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                        ...
                        <div className="space-y-4">
                            <h4 className="font-bold text-phy-text flex items-center gap-2">
                                <span className="bg-phy-bg text-phy-text w-6 h-6 rounded-full flex items-center justify-center text-xs">1</span>
                                第一步：启动 AI (配置 API Key)
                            </h4>
                            <div className="bg-phy-glass p-4 rounded-xl border border-phy-border shadow-sm text-sm text-phy-muted leading-7">
            ...
            case 'study':
                return (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                        <section>
                            <h4 className="font-bold text-phy-text font-bold text-lg mb-4 flex items-center gap-2">
                                <FileText className="text-indigo-500" /> 如何开始学习？
                            </h4>
                            <div className="grid grid-cols-1 gap-4">
                                <div className="bg-phy-bg p-4 rounded-xl border border-phy-border">
                                    <div className="font-bold text-phy-text mb-2">1. 导入素材</div>
                                    <p className="text-sm text-phy-muted">
                                        点击首页的 <strong>"导入新内容"</strong>。您可以粘贴一篇新闻、论文摘要，或者直接上传 PDF 文件。AI 会立即开始阅读。
                                    </p>
                                </div>
                                <div className="bg-phy-bg p-4 rounded-xl border border-phy-border">
                                    <div className="font-bold text-phy-text mb-2">2. 两层分析模式</div>
                                    <p className="text-sm text-phy-muted mb-3">AI 读完后，会给您展示两层信息：</p>
                                    <ul className="space-y-3">
                                        <li className="flex gap-3 items-start bg-phy-glass p-3 rounded-lg border border-phy-border shadow-sm">
                                            <Zap size={16} className="text-yellow-500 mt-0.5 shrink-0" />
                                            <div>
                                                <span className="font-bold text-phy-text font-bold">极速概览 (Turbo)</span>
                                                <p className="text-xs text-phy-muted mt-1">默认显示。包含文章摘要、核心单词表和简单语法点。适合快速通读。</p>
                                            </div>
                                        </li>
                                        <li className="flex gap-3 items-start bg-phy-glass p-3 rounded-lg border border-phy-border shadow-sm">
                                            <Sparkles size={16} className="text-purple-500 mt-0.5 shrink-0" />
                                            <div>
                                                <span className="font-bold text-phy-text font-bold">深度私教 (Deep Dive)</span>
                ...
                return (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            <div className="bg-phy-glass p-4 rounded-xl border border-phy-border shadow-sm">
                                <div className="font-bold text-phy-text mb-2">✨ 核心功能</div>
                                <ul className="text-xs text-phy-muted space-y-2 list-disc pl-4">
                            ...
                            <div className="bg-phy-glass p-4 rounded-xl border border-phy-border shadow-sm">
                                <div className="font-bold text-phy-text mb-2">🤖 AI 深度润色</div>
                                <ul className="text-xs text-phy-muted space-y-2 list-disc pl-4">
                ...
                return (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                        <section>
                            ...
                            <p className="text-phy-muted leading-relaxed mb-6">
                                别再死记硬背了。我们内置了<strong>间隔重复算法 (Spaced Repetition)</strong>，它会计算您大脑的遗忘规律。
                            </p>

                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-4 border border-phy-border rounded-xl bg-green-50/50">
                                ...
                                <div className="p-4 border border-phy-border rounded-xl bg-red-50/50">
                            ...
                            <div className="mt-4 p-4 bg-phy-bg rounded-xl border border-phy-border">
                                <h5 className="font-bold text-phy-text mb-2 text-sm">🗂️ 文件夹管理 (新功能)</h5>
                                <p className="text-xs text-phy-muted">
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-sm bg-slate-900/40 animate-in fade-in duration-200">
            <div className="bg-phy-glass rounded-2xl shadow-2xl w-full max-w-4xl h-[80vh] flex border border-phy-border overflow-hidden">

                {/* Sidebar */}
                <div className="w-64 bg-phy-bg border-r border-phy-border p-4 flex flex-col gap-2 shrink-0">
                    <div className="px-4 py-4 mb-2">
                        <h2 className="font-bold text-phy-text font-bold text-xl tracking-tight">新手指南</h2>
                        <p className="text-xs text-phy-muted mt-1">SmartLearn Pro v0.1.8</p>
                    </div>
                ...
                <div className="flex-1 flex flex-col min-w-0">
                    <div className="flex justify-end p-4">
                        <button
                            onClick={onClose}
                            className="p-2 hover:bg-phy-bg rounded-full text-phy-muted hover:text-phy-muted transition-colors"
                        >
                            <X size={24} />
                        </button>
                    </div>
