export const writingTemplates = [
    {
        ...
        content: `People hold different views on whether [rephrase topic]. While some believe [viewpoint A], I argue that [viewpoint B].
...
In conclusion, although [concession], I strongly believe that...`
    },
    {
        ...
        content: `The issue of whether [topic] remains controversial. In my view, [thesis]. I hold this opinion for two key reasons.
