...
import {
    ...
    Clock, FolderOpen, NotebookPen, Layers, Menu, Mic, PlayCircle, PenTool, FileQuestion, Share2, X, Home, Target
} from 'lucide-react';
...
const Layout = ({ currentView, setCurrentView, children, isSplit, setIsSplit, onOpenSplit, secondaryContent }) => {
    ...
    const isFixedCanvasView = currentView === 'notes' || currentView === 'exam' || currentView === 'writer';
